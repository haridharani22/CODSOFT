...
• (Optional) Logistic Regression was used only for trend observation  
...
2. Upload the Titanic dataset (Titanic_dataset.csv)  
3. Install required libraries (pandas, matplotlib, seaborn)  
4. Run the notebook cells step by step  
5. Analyze the visual outputs and conclusions  
